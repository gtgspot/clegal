...
4. On first run after a plugin update, if a populated CLAUDE.md exists at the old cache path
   (~/.claude/plugins/cache/claude-for-legal/corporate-legal-uk/<version>/CLAUDE.md for any version)
...
|---|---|---|
| VDR (Datasite, Box, iManage) | [✓ / ✗] | Diligence pulls from local folder; user drops docs in `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/deals/[code]/vdr-mirror/` |
...
**Compliance tracker:** `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/entities/compliance-tracker.yaml`
