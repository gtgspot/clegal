...
description: >
  ...
  per the trust level in `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md`. Use when user says "send to Luminance",
...
`~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md` → AI-assisted review:
...
If `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md` says no AI tool → this skill is a no-op. Everything goes through diligence-issue-extraction directly.
...
- Specify extraction targets per `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md` (which clause types)
- Note the materiality threshold so tool output can be filtered

### Step 2: Load (or instruct the loader)

Per `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md` — who loads. If it's you, generate the load instructions. If it's someone else, generate the request:
...
- Exclusivity
- [etc. per `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md`]
...
**"Use as-is":** Ingest directly into diligence findings. (Only if `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md` says this — it's rare.)
...
**Trust level:** [per `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md`]
...
- It doesn't replace the tool's output with its own judgment entirely — if `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md` says spot-check 10%, check 10%, not 100%.
- It doesn't decide the trust level — that's in `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md`, set at cold-start based on the team's experience with the tool.
