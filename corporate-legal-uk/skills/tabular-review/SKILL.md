...
1. Load `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md` → diligence structure, thresholds, house format.
...
- `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/CLAUDE.md` → diligence structure, materiality thresholds, house format preferences
- `~/.claude/plugins/config/claude-for-legal/corporate-legal-uk/deals/[code]/deal-context.md` if working a specific deal
