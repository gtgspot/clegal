...
description: >
  ...
  Runs weekly by default. Posts to the channel named in `~/.claude/plugins/config/claude-for-legal/commercial-legal-uk/CLAUDE.md` → House style
...
1. Read `~/.claude/plugins/config/claude-for-legal/commercial-legal-uk/CLAUDE.md` to get the alert destination (Slack channel or email list).
