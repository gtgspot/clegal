...
The output feeds `~/.claude/plugins/config/claude-for-legal/commercial-legal-uk/deviation-log.yaml`. The playbook-monitor agent reads that log to propose playbook updates when patterns emerge — but only from deals the solicitor hasn't flagged as one-offs.
...
Read `~/.claude/plugins/config/claude-for-legal/commercial-legal-uk/CLAUDE.md` in full. Extract:
...
Using the repository location from `~/.claude/plugins/config/claude-for-legal/commercial-legal-uk/CLAUDE.md`:
...
2. Identify the applicable playbook section(s) and governing law from `~/.claude/plugins/config/claude-for-legal/commercial-legal-uk/CLAUDE.md`.
...
```
[#] [Deal] — [Clause]
Playbook position: [standard position from `~/.claude/plugins/config/claude-for-legal/commercial-legal-uk/CLAUDE.md`]
...
Append a structured entry to `~/.claude/plugins/config/claude-for-legal/commercial-legal-uk/deviation-log.yaml` for each agreement processed.
...
Logged to: ~/.claude/plugins/config/claude-for-legal/commercial-legal-uk/deviation-log.yaml
