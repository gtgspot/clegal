...
1. Load `~/.claude/plugins/config/claude-for-legal/law-student-uk/CLAUDE.md` → outline preferences, existing outlines.
...
`~/.claude/plugins/config/claude-for-legal/law-student-uk/CLAUDE.md` → outline preferences (format, depth, existing outlines location).
