...
1. Load `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/[slug]/matter.md` → theory, pivot fact, key facts.
2. Load `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/CLAUDE.md` → Document storage sources, default matter folder pattern.
3. Follow the workflow and reference below.
4. Identify sources in order: user-provided paths this session, default matter folder, declared sources from `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/CLAUDE.md`.
...
8. Write `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/[slug]/chronology.md` (or format variant per flag).
...
- `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/[slug]/matter.md` → case theory, key facts, pivot fact (for significance tagging), key dates.
...
**Conflicts gate — unbypassable (`--matter` mode).** Before building the chronology, check `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/_log.yaml` for the matter slug. If the matter is not in `_log.yaml`, refuse and route:
...
Location: `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/[slug]/chronology.md`. Complete, tagged, annotated. The reference doc counsel works from.
