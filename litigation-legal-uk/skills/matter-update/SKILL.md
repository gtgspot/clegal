...
2. Confirm slug exists in `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/` and `_log.yaml`.
...
4. Append dated entry to `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/[slug]/history.md`.
...
- `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/[slug]/matter.md` — reference (don't rewrite)
- `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/CLAUDE.md` — risk calibration (if re-assessing risk)
...
If materiality moves to `reserved` or `disclosed`, and the matter did not previously carry a reserve or disclosure, flag the event as requiring finance / audit-committee notification per `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/CLAUDE.md` materiality thresholds.
...
### Append to `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/[slug]/history.md`
