...
- `/litigation-legal-uk:matter-workspace close <slug>` — archive a matter (move to `~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/matters/_archived/`, never delete)
...
```
~/.claude/plugins/config/claude-for-legal/litigation-legal-uk/
