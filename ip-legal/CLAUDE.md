...
| USPTO / EPO patent data (Patent Client Agents) | [PLACEHOLDER ✓/✗] | Application status, prosecution history, PTAB, assignments, MPEP, CPC come from user-supplied PDFs or are pulled by hand |
