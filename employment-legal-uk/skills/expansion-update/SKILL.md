...
1. Load `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/CLAUDE.md`.

2. Identify the tracker file: `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/expansion-[slug].yaml`. If it doesn't
