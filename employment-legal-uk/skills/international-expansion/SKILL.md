...
Read `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/CLAUDE.md` → jurisdictional footprint, escalation table, any existing
expansion notes.
...
Write a new file to `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** ~/.claude/plugins/config/claude-for-legal/employment-legal-uk/expansion-[slug].yaml
