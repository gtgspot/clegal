...
3. If a tracker file already exists for this country (`~/.claude/plugins/config/claude-for-legal/employment-legal-uk/expansion-[slug].yaml`),
...
4. Create `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/expansion-[slug].yaml` on completion.
