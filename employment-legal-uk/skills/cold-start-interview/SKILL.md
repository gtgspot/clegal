...
5. If a populated CLAUDE.md (no `[PLACEHOLDER]` markers) exists at `~/.claude/plugins/cache/claude-for-legal/employment-legal-uk/*/CLAUDE.md` but not at the config path, copy it to the config path and tell the user what was migrated.
6. Write `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/CLAUDE.md`, creating parent directories as needed.
...
> "Done. Your configuration is at `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/CLAUDE.md` — a plain text file you can read and edit directly. Anything you answered can be changed:
>
