...
Prepend the work-product header from `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/CLAUDE.md` → `## Outputs` (it differs by user role — see `## Who's using this`). Every file, log, memo, and summary produced by this skill opens with that header.
...
Read `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/CLAUDE.md` → escalation table, any investigation protocols noted.
...
`~/.claude/plugins/config/claude-for-legal/employment-legal-uk/investigation-[matter-slug]/log.yaml`:
...
`~/.claude/plugins/config/claude-for-legal/employment-legal-uk/investigation-[matter-slug]/sources-checklist.yaml`:

Generated from the investigation type. See sources checklist templates below.

`~/.claude/plugins/config/claude-for-legal/employment-legal-uk/investigation-[matter-slug]/documents-reviewed.yaml`:
...
`~/.claude/plugins/config/claude-for-legal/employment-legal-uk/investigation-[slug]/sources-checklist.yaml`.
...
If multiple investigation folders exist in `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/`, ask which matter this
...
Write the draft to `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/investigation-[slug]/memo.md`.
