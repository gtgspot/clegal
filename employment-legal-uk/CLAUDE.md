...
User-specific configuration for this plugin lives at a version-independent path that survives plugin updates:
  ...
  ~/.claude/plugins/config/claude-for-legal/employment-legal-uk/CLAUDE.md
...
4. On first run after a plugin update, if a populated CLAUDE.md exists at the old cache path
   (~/.claude/plugins/cache/claude-for-legal/employment-legal-uk/<version>/CLAUDE.md for any version)
...
|---|---|---|
| HRIS (Workday, BambooHR, Rippling, ADP) | [✓ / ✗] | Leave data tracked in `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/leave-register.yaml`; manual entry via `/employment-legal-uk:log-leave` |
...
**Leave data access:** [Legal has read access / manual — `~/.claude/plugins/config/claude-for-legal/employment-legal-uk/leave-register.yaml`]
